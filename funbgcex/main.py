...
def get_args():
    ...
    parser.add_argument("--no_usty",action="store_true",help="Extract RiPP BGCs only with a UstY homologue(s)")
    parser.add_argument("--no_kexb",action="store_true",help="Extract RiPP BGCs only with a precursor peptide with KexB cleavage sites.")
